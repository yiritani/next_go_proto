...
const (
	...
	PingServiceName = "next_go_anex.api.v1.ping.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/next_go_anex.api.v1.ping.PingService/Ping"
)

// PingServiceClient is a client for the next_go_anex.api.v1.ping.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the next_go_anex.api.v1.ping.PingService service. By
...
func NewPingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PingServiceClient {
	...
	pingServiceMethods := v1.File_protos_next_go_anex_proto_v1_ping_proto.Services().ByName("PingService").Methods()
...
// Ping calls next_go_anex.api.v1.ping.PingService.Ping.
...
// PingServiceHandler is an implementation of the next_go_anex.api.v1.ping.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/next_go_anex.api.v1.ping.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("next_go_anex.api.v1.ping.PingService.Ping is not implemented"))
}
